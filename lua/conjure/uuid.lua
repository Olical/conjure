...
local function _1_(...)
  _0_0["aniseed/local-fns"] = {require = {a = "conjure.aniseed.core", sponsors = "conjure.sponsors"}}
  return {require("conjure.aniseed.core"), require("conjure.sponsors")}
end
local _2_ = _1_(...)
local a = _2_[1]
local sponsors = _2_[2]
...
do
  ...
  do
    ...
    local function pretty0(id)
      ...
      return a.get(pretty_strs, a.inc((n % a.count(pretty_strs))))
    end
    v_23_0_0 = pretty0
    _0_0["pretty"] = v_23_0_0
    v_23_0_ = v_23_0_0
  end
  _0_0["aniseed/locals"]["pretty"] = v_23_0_
  pretty = v_23_0_
end
              -- (v4) (pretty (v4))
return nil