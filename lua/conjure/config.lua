...
assoc_in({"filetype_client"}, a.merge((nvim.g["conjure#filetype_client"] or {}), {clojure = "conjure.client.clojure.nrepl", fennel = "conjure.client.fennel.aniseed", janet = "conjure.client.janet.netrepl"}))
