...
assoc_in({"filetype_client"}, a.merge({clojure = "conjure.client.clojure.nrepl", fennel = "conjure.client.fennel.aniseed", janet = "conjure.client.janet.netrepl", racket = "conjure.client.racket.nrepl"}, (nvim.g["conjure#filetype_client"] or {})))
