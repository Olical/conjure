...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("conjure.aniseed.deps.fennel"), autoload("conjure.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {fennel = "conjure.aniseed.deps.fennel", nvim = "conjure.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
