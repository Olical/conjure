...
M["on-filetype"] = function()
  ...
  mapping.buf("CljMacroExpand1", cfg({"mapping", "macro_expand_1"}), util["wrap-require-fn-call"]("conjure.client.clojure.nrepl.action", "macro-expand-1"), {desc = "Run the current form wrapped in (macroexpand-1 ...)"})
  mapping.buf("CljMacroExpand", cfg({"mapping", "macro_expand"}), util["wrap-require-fn-call"]("conjure.client.clojure.nrepl.action", "macro-expand"), {desc = "Run the current form wrapped in (macroexpand ...)"})
  mapping.buf("CljMacroExpandAll", cfg({"mapping", "macro_expand_all"}), util["wrap-require-fn-call"]("conjure.client.clojure.nrepl.action", "macro-expand-all"), {desc = "Run the current form wrapped in (clojure.walk/macroexpand-all ...)"})
  ...
  mapping.buf("CljListTestRunners", cfg({"mapping", "select_test_runner"}), util["wrap-require-fn-call"]("conjure.client.clojure.nrepl.action", "select-test-runner"), {desc = "Select active test runner"})
