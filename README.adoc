 ...
 * https://www.gnu.org/software/mit-scheme/[MIT Scheme] over stdio (https://github.com/Olical/conjure/wiki/Quick-start:-MIT-Scheme-(stdio)[quickstart])
 ...
 * https://github.com/Olical/conjure/wiki/Quick-start:-MIT-Scheme-(stdio)[MIT Scheme (stdio)]
