 ...
 * https://www.lua.org/[Lua] inside Neovim (https://github.com/Olical/conjure/wiki/Quick-start:-Lua-(stdio)[quickstart])
 ...
 * https://github.com/Invertisment/conjure-clj-additions-nrepl[Invertisment/conjure-clj-additions-nrepl]: Jump to failing Clojure test and more.
 * https://github.com/Invertisment/conjure-clj-additions-vanilla[Invertisment/conjure-clj-additions-vanilla]: Jump to failing Clojure test for Conjure when not using nREPL.
