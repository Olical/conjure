 ...
 * https://racket-lang.org/[Racket] over https://gitlab.com/technomancy/ogion[Ogion nREPL] (https://github.com/Olical/conjure/wiki/Quick-start:-Racket-(nREPL)[quickstart])
 ...
 * Open a file of a supported file type such as `clojure`, `fennel`, `janet` or `racket`.
 ...
 * https://github.com/Olical/conjure/wiki/Quick-start:-Racket-(nREPL)[Racket (nREPL)]
